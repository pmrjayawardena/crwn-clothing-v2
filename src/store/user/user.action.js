...
/*
	...
	EMAIL_SIGN_IN_STRT: 'EMAIL_SIGN_IN_STRT',
...
export const emailSignInStart = (email, password) => {
	return { type: USER_ACTION_TYPES.EMAIL_SIGN_IN_STRT, payload: { email, password } };
};
export const signInSuccess = (user) => {
	return { type: USER_ACTION_TYPES.SIGN_IN_SUCESS, payload: user };
};
